...
def generate():
    ...
    Label(cp, text='File Saved!', bg='#D4F1F4' , fg='black', font=('Cooper Black', 8)).pack()
...
frame = Frame(cp, bg='#006DFF')
frame.pack(expand=True)

#------------------ENTER THE TEXT OR URL------------------

Label(frame, text='Enter the Text or URL : ', font=('Cooper Black', 16),
      bg='#006DFF').grid(row=0, column=0, sticky='w')
...
Label(frame, text='File Name(Save As) : ', font=('Cooper Black', 16),
      bg='#006DFF').grid(row=1, column=0, sticky='w')
